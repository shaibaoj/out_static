    ...
    window.UEDITOR_CONFIG = {
        ...
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
         , toolbars:[
            ['fullscreen', 'undo', 'redo', '|',
             	'bold', 'h1label','h2label','h3label', '|', 'removetag', 'blockquote', 'insertunorderedlist',
             	'|', 'imgmanage', 'refer', 'referinfo', 'imglocal','extranetvideo','extranetinfo','native']
                ],
         contextMenu : [],
        ...
        /*, toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace', 'help' , 'imgmanage' , 'refer', 'attach' , 'water', 'm2o_pagebreak', 'm2o_auto_pagebreak', 'pizhu']
        ]*/
